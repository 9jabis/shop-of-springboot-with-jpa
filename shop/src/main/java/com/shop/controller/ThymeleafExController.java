...
public class ThymeleafExController {
    ...
    public String thymeleafExample03(Model model) {
        ...
        for(int i=1; i<=10; i++) {  //반복문을 통해 화면에서 출력할 10개의 itemDto 객체를 만들어서 itemDtoList에 넣어준다.
            ItemDto itemDto = new ItemDto();
        ...
        model.addAttribute("itemDtoList", itemDtoList); //화면에서 출력할 itemDteoList를 model에 담아서 View에 전달한다.
